...
def change_sun(sigma, volume0, rneedle, output_dir, sun_strength = 6, cam_steps=5, camx_steps=3, sun_steps = 4, sun_rotate = 360, sun_angle=180, subject = bpy.context.object):
  import os
